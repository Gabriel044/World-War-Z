...
export default function BunkerMap() {
  ...
  useEffect(() => {
    mapboxgl.accessToken =
      "pk.eyJ1IjoicHJ1ZWJhYSIsImEiOiJjbDJ6aHRldzQxZnJ0M2lwMmpmbHM1ZHJjIn0.7usXzE9zv3Oi6NpMMYBqJA";
    //mapa
    setMap(
      new mapboxgl.Map({
        ...
        center: [-103.45481, 20.732498], // [lng, lat] inicia en el tec
